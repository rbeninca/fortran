...
CALL SYSTEM('uname > /dev/null', os)
      IF (os .EQ. 0) THEN
         PRINT *, 'Sistema operacional: Linux ou Unix'
         CALL SYSTEM('xdg-open out1.txt')
      ELSE
         PRINT *, 'Provavelmente Windows'
         CALL SYSTEM('start notepad out1.txt',os)
      ENDIF
